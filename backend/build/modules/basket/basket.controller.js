...
router.get("/basket/minus-quantity/:id", authMiddlewareUser, async (req, res) => {
    try {
...
router.post("/basket/send-data-to-delivery", authMiddlewareUser, async (req, res) => {
    try {
...
router.get("/catalogue/get-total-price", authMiddlewareUser, async (req, res) => {
    try {
